...
<template>
  ...
  <br><br>
    ...
    <div v-if = "qnum < 10">
      ...
      <div id="not-mobile" class="d-none d-sm-block">
        <div class="row">
      ...
      </div> <!-- end of answer row for non-mobiles -->

      <!-- answers for mobile screens -->
      <div id="mobile" class="d-block d-sm-none">
        ...
        </div> <!-- end of second answer row -->
      <br><br>
    </div> <!-- end v-if qnum<10 -->
    
    <!-- Display Extra Question -->
    <div v-if = "qnum=10"></div>
      ...
      <h2 v-if = "$route.params.lang === 'en'"> If you have chosen a number higher than 0 for any problems,
                    ...
                    at home, or get along with other people?  </h2>
      ...
      <div id="mobile" class="d-block d-sm-none">
        ...
        </div> <!-- end first row of answers for mobiles -->
        <br>
        <div class="row">
            <a class="col text-center answer" @click="save_scores(tot,2)">
                <h2 v-if = "$route.params.lang === 'xh'">
        ...
        </div> <!-- end second row of ansers for mobiles -->     
        <br>
      </div> <!-- end mobile section for qnum=10 -->
