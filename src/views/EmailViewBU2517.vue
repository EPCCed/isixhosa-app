  ...
  <div class="row">
    <div class="footer"> 
        ...
        <div class="footer-text">
          Researchers or clinicians may enter an email address 
          to which anonymised user responses from the session 
          will be exported.
