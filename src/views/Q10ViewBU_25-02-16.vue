...
const questions = {
    "English": "If you have chosen a number higher than 0 for any problems, how difficult have these problems made it for you to do your work, take care of things at home, or get along with other people?", 
    "isiXhosa": "Ukuba ngaba ukhethe inani elingaphezulu kwe-0 ngazo naziphi iingxaki ezi ngxaki zenze kwanzima kangakanani kuwe ukuba wenze umsebenzi wakho, ukulungisa izinto ekhaya, okanye ukuvana nabanye abantu?"
}
const answers = {
  'English': [
...
const questions_audio = {
    'English': new Audio(soundXQ_en),
    'isiXhosa': new Audio(soundXQ_xh)
    }
...
function setlang(langparam) {
  ...
  // }
  function gotoQ9() {
    console.log("FUNCTION gotoQ9:  language=", lang.value)
    router.push({name: 'question', params: { lang:lang.value, total: 0, qnumber: 9}});
  ...
  function gotoComplete() {
    ...
    if (selected.value == null)
      ...
      router.push({name: 'complete', params: { lang:'en', total:0}});
    //to="{ name: 'complete', params: { lang, total:0}"
    //<router-link :to="{ name: 'complete', params: { lang, total:0} }" class="rightbutton" style="text-align: right"> &#8594 </router-link>
  }
